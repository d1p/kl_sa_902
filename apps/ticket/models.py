...
class CustomerTicketTopic(models.Model):
    text = models.TextField(max_length=300)
    text_in_ar = models.TextField(max_length=300, verbose_name="Text in arabic")
    created_at = models.DateTimeField(auto_now_add=True)
...
class CustomerTicket(models.Model):
    ...
    topic = models.ForeignKey(CustomerTicketTopic, on_delete=models.CASCADE)
    sub_topic = models.CharField(max_length=300, help_text=_("Topic Name"))
